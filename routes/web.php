...
Route::prefix('estagio')->group(function () {
    ...
    Route::get('/documentos/{id}/termo-de-encaminhamento', [DocumentoEstagioController::class, 'termo_encaminhamento_form'])->name('estagio.documentos.termo-de-encaminhamento');
    Route::post('/documentos/{id}/termo-de-encaminhamento', [DocumentoEstagioController::class, 'termo_encaminhamento'])->name('estagio.documentos.termo-de-encaminhamento.store');
...
Route::get('/termo_encaminhamento', [DocumentoEstagioController::class, 'termo_encaminhamento'])->name('Estagio.formularios.termo_encaminhamento');
