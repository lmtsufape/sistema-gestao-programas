        ...
        if ($relatorio->status == RelatorioFinal::STATUS_ENUM['aprovado']) {
            $json = [
                [
                    ...
                    'atividades' => [
                        [
                            'descricao' => 'Atividade do relatório final', // Adjust based on actual data
                            'inicio' => \Carbon\Carbon::parse($relatorio->editalAlunoOrientador->data_inicio)->format('Y-m-d'),
                            'fim' => \Carbon\Carbon::parse($relatorio->editalAlunoOrientador->data_fim)->format('Y-m-d'),
                            'participantes' => [
                                [
                                    ...
                                    'instituicao' => 'Universidade Federal de Tecnologia', // Adjust based on actual data
                                    'curso' => $relatorio->editalAlunoOrientador->aluno->curso->nome ?? 'Ciência da Computação'
                                ]
                                // Add more participants here if available
                            ]
                        ]
                        // Add more activities here if available
                    ]
                ]
            ];
        }
