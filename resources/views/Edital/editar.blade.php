...
@section("body")
    ...
    <form action="{{url("/editals/$edital->id")}}" method="post">
        ...
        <input type="date" name="data_inicio" id="data_inicio" value="{{$edital->data_inicio}}"><br><br>

        <label for="data_fim">Data de fim:</label>
        <input type="date" name="data_fim" id="data_fim" value="{{$edital->data_fim}}"><br><br>

        <label for="semestre">Semestre:</label>
        <input type="text" name="semestre" id="semestre" value="{{$edital->semestre}}"><br><br>
