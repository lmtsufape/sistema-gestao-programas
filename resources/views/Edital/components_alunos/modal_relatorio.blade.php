                    ...
                    <div class="modal-body py-4 px-5">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 align-items-center">
                                ...
                                <a href="{{ route('relatorio.download', $relatorio_enviado->id) }}" target="_blank"
                            ...
                            <div class="col-md-6 align-items-center">
                                ...
                                <a href="{{ route('relatorio.visualizar', $relatorio_enviado->id) }}" target="_blank"
                            ...
                            @if ($status === 1)
                                <div class="col-12">
                                    <label for="parecer" class="form-label text-muted small">Digite seu Parecer
                                        (opcional)</label>
                            ...
                            @if ($status === 1)
                                <div class="col-12">
                                    <label for="carga_horaria" class="form-label text-muted small">Carga Horária</label>
                                    <input class="form-control" name="carga_horaria" id="carga_horaria" placeholder="Carga Horária" type="number" min="0" step="1" value="{{ $relatorio_enviado->carga_horaria }}"></input>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="modal-footer border-0 px-5 pb-4">
                            @if ($status === 1)
                                <button type="button" class="btn btn-outline-warning"
                                    onclick="confirmParecer('devolver')">
                            ...
                            @else
                                <button type="button"
                                    class="btn {{ $status === 2 ? 'btn-success' : 'btn-warning' }} w-100" disabled>
                                    {{ $statusLabel }}
                                </button>
                            @endif
                        </div>
