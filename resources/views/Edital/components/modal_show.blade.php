    ...
    <div class="modal-content modal-create p-3" style="border-radius: 15px; background-color: #F9F9F9; font-family: 'Roboto', sans-serif;">
      ...
      <div class="modal-body" style="overflow: auto">
        <div class="mb-3">
          ...
          <div style=" display:flex; flex-wrap:wrap; justify-content:center; align-items:center;">
            <a class="link" alt="Listar disciplinas" href="{{  route('edital.listar_disciplinas', ['id' => $edital->id] )  }}" style="background: #EEEEEE; border-radius: 13px; border: 1px #D3D3D3;width: 100%; display:flex; flex-direction:row; flex-wrap:wrap; justify-content:center; align-items:center; padding:5px; margin:2px;">
              <img src="{{asset("images/listaredital.png")}}" >
              Listar disciplinas
            </a> 
          </div> 
        </div>
