...
<style>
  ...
  <div class="container">
    ...
    {{--  <a type="button" data-bs-toggle="modal" data-bs-target="#modal_create">
      <img src="{{asset("images/add-icon.png")}}" class="add-button" alt="Adicionar orientador">
    </a>  --}}
    ...
    margin-bottom: 2%; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
      <img src="{{asset("images/edit-outline.png")}}" alt="Cadastrar orientador" style="padding: 0px 5px 5px 5px">Editar orientador
    </button>  --}}
    </div>
    ...
    <div style="background-color: #34A853; border-radius: 25px; padding-left: 2%; padding-right: 2%;
     display: flex; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
      ...
      <div style="display: flex; align-self: center; margin-right: auto">
        ...
        <div style="display: flex; margin: 10px">
          <a><img src="{{asset("images/delete.png")}}" alt="Deletar orientador"></a>
        ...
        <table class="table" style="background-color: #F2F2F2; ">
          ...
          <tbody>
                <tr> 
                  ...
                  <td>
                    <a type="button" data-bs-toggle="modal" data-bs-target="#modal_edit_{{$orientador->id}}">
                      <img src="{{asset("images/info.png")}}" alt="Info orientador">
                    </a>
                    <a type="button" data-bs-toggle="modal" data-bs-target="#modal_documents_{{$orientador->id}}">
                      <img src="{{asset("images/document.png")}}" alt="Documento orientador">
                      {{--  TODO: Fica pra fazer o modal depois  --}}
                    </a>
                    <a href="{{url("/orientador/$orientador->id/edit")}}">
                      <img src="{{asset("images/edit-outline-blue.png")}}" alt="Editar orientador">
                    </a>
                    <a type="button" data-bs-toggle="modal" data-bs-target="#modal_delete_{{$orientador->id}}">
                      <img src="{{asset("images/delete.png")}}" alt="Deletar orientador">
                    </a>
                    
                    
                  </td>
                </tr>
                @include("Orientador.components.modal_edit", ["orientador" => $orientador])
