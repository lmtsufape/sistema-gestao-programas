          ...
          <div style="display: flex; gap: 30px; margin: 15px 15px 15px 15px;">
              ...
              <tbody>
                      ...
                      <td>
                          ...
                          <a type="button" data-bs-toggle="modal" data-bs-target="#modal_show_{{$projeto->id}}">
                              <img src="{{asset("images/info.png")}}" alt="Info projeto">
                          </a>
                          <a href="{{url("/projetos/$projeto->id/edit")}}">
                              <img src="{{asset("images/edit-outline-blue.png")}}" alt="Editar projeto">
                          </a>
                          <a type="button" data-bs-toggle="modal" data-bs-target="#modal_delete_{{$projeto->id}}">
                              <img src="{{asset("images/delete.png")}}" alt="Deletar projeto">
                          </a>
                      </td>
                      </tr>

                      @include("Projeto.components.modal_show", ["projeto" => $projeto])
                      @include("Projeto.components.modal_delete", ["projeto" => $projeto])
                  @endforeach
              </tbody>
              </table>
