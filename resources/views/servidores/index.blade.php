      ...
      <div style="display: flex; gap: 30px">
        ...
        ;margin-bottom: 5px; min-height: 350px">
          ...
          <tr>
            ...
            <th scope="col" style="border-right: 1px solid #d3d3d3;">Tipo de servidor</th>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a type="button" data-bs-toggle="modal" data-bs-target="#modal_documents_{{$servidor->id}}">
                      <img src="{{asset("images/document.png")}}" alt="Documento servidor"  style="height: 30px; width: 30px;">
                      {{--  TODO: Fica pra fazer o modal depois  --}}
                    </a>
                    <a href="{{url("/servidores/$servidor->id/edit")}}">
                      <img src="{{asset("images/edit-outline-blue.png")}}" alt="Editar servidor"  style="height: 30px; width: 30px;">
                    </a>
                    <a type="button" data-bs-toggle="modal" data-bs-target="#modal_delete_{{$servidor->id}}">
                      <img src="{{asset("images/delete.png")}}" alt="Deletar servidor" style="height: 30px; width: 30px;">
                    </a>
        ...
        ; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); width: 150px; height: 40%;">
          ...
          <div style="align-self: center; margin-right: auto">
            ...
            <div style="display: flex; margin: 10px">
              <a><img src="{{asset("images/delete.png")}}" alt="Deletar servidor" style="width: 20px; height: 20px;"></a>
