...
@section('body')
    <div class="container"
        style="display: flex; justify-content: center; align-items: center; margin-top: 2.5em; margin-bottom:3.6em;">
        @can('cadastrar servidor')
            ...
            <div class="fundocadastrar">
                ...
                <hr class="divisor">
                <form action="{{ route('servidores.store') }}" method="POST" class="row needs-validation" novalidate
                    style="text-align:start;" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div style="display:flex; flex-direction: column;">
                        ...
                        <div style="display: flex; flex-direction: row; gap:15px; margin-bottom:20px; align-items:center">
                            <img src="/images/sem-foto-perfil.png" alt="Foto Perfil"
                        ...
                        <input type="text" name="nome" id="nome" placeholder="Digite o nome" class="boxcadastrar"
                            value="{{ old('nome') }}">
                        ...
                        <input type="text" name="nome_social" id="nome_social" placeholder="Digite o nome social"
                            class="boxcadastrar" value="{{ old('name_social') }}">

                        <label for="tipo_servidor" class="titulopequeno">Tipo do servidor<strong
                                style="color: #8B5558">*</strong></label>
                        <select name="tipo_servidor" id="tipo_servidor" class="boxcadastrar"
                        ...
                        <label for="cpf" class="titulopequeno" required>CPF<strong
                                style="color: #8B5558">*</strong></label>
                        <input class="boxcadastrar cpf-autocomplete" type="text" name="cpf" id="cpf"
                            placeholder="Digite o CPF" class="boxcadastrar" value="{{ old('cpf') }}">

                        <label for="email" class="titulopequeno">E-mail<strong style="color: #8B5558">*</strong></label>
                        <input type="text" name="email" id="email" placeholder="Digite o E-mail" class="boxcadastrar"
                            value="{{ old('email') }}">

                        <label class="titulopequeno" for="instituicaoVinculo">Intituição<strong
                                style="color: #8B5558">*</strong></label>
                        <div class="vinculo">

                            <div class="form-check">
                                <input type="radio" id="instituicaoVinculo" value="UFAPE" name="instituicaoVinculo" required>
                                <label class="textinho" for="instituicaoVinculo">Universidade Federal do Agreste de
                                    Pernambuco</label>
                            </div>
                        ...
                        <input type="text" name="matricula" id="matricula" placeholder="Digite a matrícula (Exemplo: SIAPE)"
                            class="boxcadastrar" value="{{ old('matricula') }}">
                    ...
                    <div class="container-botoes">
                        <input type="button" value="Voltar" href="{{ url('/servidores/') }}"
                            onclick="window.location.href='{{ url('/servidores/') }}'" class="botaovoltar">
