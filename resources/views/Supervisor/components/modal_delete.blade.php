@can('deletar supervisor')
    <div class="modal" id="modal_delete_{{ $supervisor->id }}" tabindex="-1" aria-labelledby="deleteModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content fundomodaldelete">
                ...
                <div class="modal-body" style="text-align: start">
                    <p class="titulomodal">Deseja realmente remover o supervisor {{ $supervisor->nome }}?</p>
                </div>
