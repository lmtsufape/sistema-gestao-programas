    ...
    @can('editar supervisor')
        ...
        <div class="fundocadastrar">
            <h1 class="titulogrande">
                Editar Supervisor</h1>
            <hr class="divisor">
                <form action="{{route('supervisor.update', ['id' => $supervisor->id])}}" method="POST" class="row needs-validation" novalidate style="text-align:start;" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    ...
                    <div style="display:flex; flex-direction: column;">
                            ...
                            <input type="text" name="nome" id="nome" placeholder="Digite o nome" class="boxcadastrar" value="{{ $supervisor->nome }}">

                            <label for="cpf" class="titulopequeno" required >CPF<strong style="color: #8B5558">*</strong></label>
                            <input class="boxcadastrar cpf-autocomplete" type="text" name="cpf" id="cpf" placeholder="Digite o CPF" class="boxcadastrar" value="{{ $supervisor->cpf }}">

                            <label for="email" class="titulopequeno">E-mail<strong style="color: #8B5558">*</strong></label>
                            <input type="text" name="email" id="email" placeholder="Digite o E-mail" class="boxcadastrar" value="{{ $supervisor->email }}">

                            <label for="telefone" class="titulopequeno">Telefone<strong style="color: #8B5558">*</strong></label>
                            <input class="boxcadastrar telefone-autocomplete" type="text" name="telefone" id="telefone" placeholder="Digite o telefone" value="{{ $supervisor->telefone }}">

                            <label for="formacao" class="titulopequeno">Formacao<strong style="color: #8B5558">*</strong></label>
                            <input type="text" name="formacao" id="formacao" placeholder="Digite a formação" class="boxcadastrar" value="{{ $supervisor->formacao }}">
