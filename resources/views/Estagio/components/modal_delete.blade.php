@canany(['admin', 'servidor'])
  <div class="modal fade" id="modal_delete_{{$estagio->id}}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content modal-create" style="border-radius: 15px; background-color: #F9F9F9; font-family: 'Roboto', sans-serif;">
        ...
        <div class="modal-footer d-flex justify-content-between">
          ...
          <form action="{{route('estágio.delete',$estágio->id)}}" method="post">
            @method("DELETE")
            @csrf
