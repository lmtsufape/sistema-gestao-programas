...
<div class="fundocadastrar" style="width: 70%; background: #FBFBFB; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 10px; margin-bottom: 50px; margin-top: 4rem;    
    ...
    @auth
        ...
        <div class="container-fluid" style="padding-top: 10px;">
            ...
            <img src="/images/fotos-perfil/{{ $orientador->user->image }}"  class="img-fluid" style="width: 80px; height: 80px;" alt="Foto de perfil">
            ...
            <img src="/images/sem-foto-perfil.png"  class="img-fluid" style="width: 80px; height: 80px;" alt="Foto de perfil">
                 <div style="color: var(--preto-p-200, #2B2B2B); font-family: Inter; font-size: 16px; font-style: normal; font-weight: 700; line-height: normal;">{{$orientador->user->name_social}}</div></div>
            </div>
             @endif
        ...
        <div style="display:flex; justify-content:right; margin-bottom: 10px;  gap: 20px; margin-top: 20px">
            <a href="{{url("/orientadors/".$orientador->id."/editarmeuperfil")}}" class="btn btn-primary"
