    ...
    @auth
        @if (auth()->user()->typage_type == "App\Models\Aluno")
            <div class="container-fluid" style="padding-top: 10px;">
                ...
                <img src=" /images/fotos-perfil/{{ $aluno->user->image }}" class="img-fluid" style="width: 80px; height: 80px;" alt="Foto de perfil">
                ...
                <div style="display: flex; flex-direction: column; align-items: flex-start;">
                    <div style="color: var(--preto-p-200, #2B2B2B); font-family: Inter; font-size: 16px; font-style: normal; font-weight: 700; line-height: normal;">{{$aluno->user->name_social}}</div></div>
                </div>
                @endif
