...
<div class="fundocadastrar" style="width: 70%; background: #FBFBFB; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 10px; margin-bottom: 50px; margin-top: 4rem;
    ...
    <div class="container-fluid" style="padding-top: 10px;">
        ...
        <div style="display: flex; flex-direction: row; align-items: center; gap: 20px;">
            <img src="/images/fotos-perfil/{{$servidor->user->image}}" class="img-fluid" style="width: 80px; height: 80px; border-radius:50px" alt="Foto de perfil">
        ...
        <div style="display:flex; justify-content:right; margin-bottom: 10px;  gap: 20px; margin-top: 20px">
            <a href="{{url("/servidores/".$servidor->id."/editarmeuperfil")}}" class="btn btn-primary" style="display: flex; padding: 8.5px 15.5px; align-items: center; gap: 6px; border-radius: 10px; border: 1.5px solid var(--teste-12, #BD8184); background-color: white; color: var(--teste-11, #972E3F);
